c*************************************************************
      subroutine elem607 (ielem,itask,pelem,nnode,estif,eforc,elnods,
...
c     check for error in input file
      if (alpha(1).lt.0.0d0) then
        print*,'elem607.f: alpha(1) is less than 0.0d0: exiting'
        stop
      elseif (alpha(2).lt.0.0d0) then
        print*,'elem607.f: alpha(2) is less than 0.0d0: exiting'
        stop
      elseif (beta(1).le.0.0d0) then
        print*,'elem607.f: beta(1) is less or equal to 0.0d0: exiting'
        stop
      elseif (beta(2).le.0.0d0) then
        print*,'elem607.f: beta(2) is less or equal to 0.0d0: exiting'
        stop
c      elseif (Treg(1).le.0.0d0) then
c        print*,'elem607.f: Treg(1) is less or equal to 0.0d0: exiting'
c        stop
c      elseif (Treg(2).le.0.0d0) then
c        print*,'elem607.f: Treg(2) is less or equal to 0.0d0: exiting'
c        stop
      endif
