...
)
{
    ...
    user = Com->user ;
    user->x = x ;
    /* user->itNum = Com->cgiter + Com->cbbiter + Com->iter ;*//* added JFD */
    user->itNum = Com->cgiter + Com->iter ;/* added JFD */
    Com->nf++ ;
    if ( Com->DimReduce )
    {
